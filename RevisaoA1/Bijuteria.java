...
class Bijuteria {
    ...
    //construtor
    public Bijuteria(String tipo, double preco, int id) {
        this.tipo = tipo;
        this.preco = preco;
        this.id = id;
    }
...
class Loja {
    ...
    public static void main(String[] args) {
        ...
        minhaBijuteria.adicionarBiju(new Bijuteria("cordao", 5.80, 1));
        minhaBijuteria.adicionarBiju(new Bijuteria("pulseira", 9.50, 2));
        minhaBijuteria.adicionarBiju(new Bijuteria("brinco", 15.60,3));

        minhaBijuteria.removerBiju(new Bijuteria("cordao", 5.80, 1));

        // Implemente métodos para atualizar e consultar dados
    }
}
